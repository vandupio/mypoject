...
$shorter = substr($lastpost->article, 0, 200);
...
<div class="jumbotron">
    ...
    <div class="carousel-inner">
		<div class="carousel-item active" style="background:url({{asset("/storage/images/kamyan.jpg") }})no-repeat center center fixed;background-size: cover;">  	
			<div class="container">
      ...
      @foreach($thisfeedslist as $list)
	        <div class="carousel-item" style="background:url({{asset("/storage/images/{$list->Imagefilename}")}})no-repeat center center fixed;background-size: cover;">    
	        ...
	        <div class="container">
	          <div class="carousel-caption">
	            ...
	            <p>
                <?php
                  $shorter = substr($list->article, 0, 150);
...
<hr class="featurette-divider">
    <div class="row">
      <div class="col-lg-4">
       <div id="piccon">
            <img id=imagcon src="{{asset("/storage/images/my.jpg")}}" />
          </div>
        <h2>Me</h2>
      ...
      <div class="col-lg-4">
        <div id="piccon">
            <img id=imagcon src="{{asset("/storage/images/fil.jpg")}}" />
          </div>
      ...
      <div class="col-lg-4">
        <div id="piccon">
            <img id=imagcon src="{{asset("/storage/images/kitch-jar.jpg")}}" />
          </div>
