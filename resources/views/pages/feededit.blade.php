...
<div class="container mt-5">
	<div class="row">
		...
		<div class="col-sm-12 pt-2" style="text-align: center;">
			<img id="frame" class="m-2" src="{{asset('/storage/images/'.$pic)}}" width="250px;" alt="Primary Image" />
		</div>
	</div>
	<!-- -->
	<label>Article</label>
	<textarea name="editor" class="ckeditor form-control" style="height: 250px;">{{$article}}</textarea>
