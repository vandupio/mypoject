...
<div class="container mt-5">
	<div class="row">
		...
		<div class="col-sm-12 pt-2" style="text-align: center;">
            ...
            <img  id="frame" class="m-2" src="{{asset("storage/images/noimage.jpg")}}"  alt="Primary Image" style="width: 300px;height: auto;"/>

		</div>
	</div>
	<label>Article</label>
		<textarea name="editor" class="ckeditor form-control" style="height: 250px;"></textarea>
